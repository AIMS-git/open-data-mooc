...
1. _Service agreements_. As an API is a service, this guarantees access to data and can often be accompanied with service level agreements for those who wish to use them.
